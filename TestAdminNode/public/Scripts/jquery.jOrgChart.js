...
(function($) {
  ...
  function buildNode($node, $appendTo, level, opts) {
    ...
    var $nodeDiv;
    var $nodeP;
//  console.log($childNodes.attr("id"))
...
//        	$(".jOrgChart").find('.select').removeClass('select')
//           $this.addClass('select')
//           $this.siblings().addClass('select')
            Pid=$this.find("input").val()
            Name=$this.text()
            window.sessionStorage["did"] = Pid;
            window.sessionStorage["dName"] = Name;
